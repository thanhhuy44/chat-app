...
function ChatRoom() {
  return (
    <div className="absolute top-4 right-0 left-4 h-full rounded-xl bg-primary-5 overflow-hidden flex  flex-col justify-between">
      <div className="flex items-center gap-x-4 h-20 py-4 px-8 bg-primary-3">
        <div className="relative h-full">
          <Image
            className="block h-full w-auto aspect-square rounded-full"
            src={avatar}
            alt="avatar"
          />
          <div className="w-3 h-3 absolute bottom-0 right-0 rounded-full bg-green-500"></div>
        </div>
        <h4 className="font-semibold text-4xl leading-[72px] text-primary-1">
          User Name 1
        </h4>
      </div>
