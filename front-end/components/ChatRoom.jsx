...
function ChatRoom() {
  ...
  useEffect(() => {
    const conversationId = router.query.slug; // Specify the conversation ID here
  ...
  return (
    <div className="absolute top-4 right-0 left-4 h-full rounded-xl bg-primary-5 overflow-hidden flex flex-col justify-between">
      {data && (
        <>
          <div className="flex items-start gap-x-4 py-4 px-8 bg-primary-3">
            <div className="relative aspect-square">
              <div className="mt-1 block w-12 h-12 aspect-square">
